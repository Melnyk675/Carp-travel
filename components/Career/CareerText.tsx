...
const CareerText = () => {
  return (
    <div className='container flex flex-col md:mr-0 xl:mr-6'>
      <h2 className='text-white hidden font-extralight xl:flex xl:text-4xl xl:leading-10 uppercase xl:ml-[142px] xl:mb-[44px]'>Why Us ?</h2>
      <ul className='flex flex-col gap-6 gap-y-4 mr-[90px] text-right md:w-[230px] md:gap-y-8 xl:w-full md:mr-0 md:mb-0'>
